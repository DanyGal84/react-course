  ...
  render() {
    const characters = (
      this.state.userInput.split("").map((char, index) => {
        return <CharComponent character={char} delete={() => {this.onDeleteHandler(index)}} key={char+index}/>
      })
    );
    ...
    return (
      <div className="App">
        ...
        <input type="text" onChange={this.onChangeTextHandler} value={this.state.userInput}/>
